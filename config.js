...
module.exports = {
    ...
    OWN: process.env.OWN === undefined ? '94761002014,0' : process.env.OWN,
    OWN2: process.env.OWN2 === undefined ? '94771159984,0' : process.env.OWN2,
    OWN3: process.env.OWN3 === undefined ? '94785977446,0' : process.env.OWN3,
    OWN4: process.env.OWN4 === undefined ? '94767132695,0' : process.env.OWN4,
    OWN5: process.env.OWN5 === undefined ? '94757405652,0' : process.env.OWN5,
    OWN6: process.env.OWN6 === undefined ? '94712174349,0' : process.env.OWN6,
    DEBUG: DEBUG,
